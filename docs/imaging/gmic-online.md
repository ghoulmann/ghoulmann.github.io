...
5. When I'm happy with the preview, I click _Render Full Image_. You have two choices: _Download_ and _Set as New Input_. Download to inspect the full-resolution output for details in shadows and highlights.

![](../assets/images/GMICImage.jpg)
...
With proper filter tuning and curve adjustments, you can achieve consistent, reproducible results across batches of images using bash scripts that invoke G'MIC.
